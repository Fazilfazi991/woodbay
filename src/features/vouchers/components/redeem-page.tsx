    ...
    <>
      <section className="bg-[color:var(--background-deep)] text-[color:var(--foreground-light)]">
        <Container className="py-14 sm:py-20">
          ...
          <h1 className="font-display mt-5 max-w-3xl text-[2.5rem] leading-[.94] sm:text-7xl">
            Voucher Verification.
          </h1>
          <p className="mt-6 max-w-2xl text-base leading-7 text-[color:var(--muted)]">
            Submit product, dealer and purchase-reference information for
            Woodbay’s team to review. This is not a shopping coupon or
        ...
        <Container className="max-w-4xl">
          <div className="grid gap-8 lg:grid-cols-[.65fr_1.35fr]">
            <div>
              ...
              <h2 className="font-display mt-5 text-4xl">Request a review.</h2>
              <p className="mt-4 text-sm leading-7 text-[color:var(--muted-dark)]">
                Verification applies only to selected products and cases.
                Submitting this form does not redeem, approve or reject a
                voucher automatically.
              </p>
            </div>
            <div className="border border-[#d7cebf] bg-white p-5 sm:p-8">
              <VerificationRequestForm key={initialCode} />
            </div>
          </div>
        </Container>
      </Section>
