...
insert into public.product_categories (name, slug, parent_id, sort_order, is_active) values
  ('Smart Kitchen & Wardrobe Solutions', 'kitchen-wardrobe-accessories', null, 10, true),
...
with canonical(name, slug, parent_slug, group_name, sort_order) as (values
  ...
  ('Wallpaper','wallpaper','home-decor','Home Decor',10),('PU Panels','pu-panels','home-decor','Home Decor',20),('Glass Mosaic Tiles','glass-mosaic-tiles','home-decor','Home Decor',30),('3D PVC Panels','3d-pvc-panels','home-decor','Home Decor',40),('Charcoal Louvers','charcoal-louvers','home-decor','Home Decor',60),('Metallic Sheets & Louvers','metallic-sheets-louvers','home-decor','Home Decor',70),('Metallic Sheets','metallic-sheets','home-decor','Home Decor',80),('UV Marble Sheets','uv-marble-sheets','home-decor','Home Decor',90),('Crystal Acrylic Prints','crystal-acrylic-paintings','home-decor','Home Decor',100),('Mattresses','mattresses','home-decor','Home Decor',110),('Blinds','blinds','home-decor','Home Decor',120),('Vertical Gardens','artificial-vertical-gardens','home-decor','Home Decor',130),('Artificial Grass','artificial-grass','home-decor','Home Decor',135),('Water Fountains','water-fountains','home-decor','Home Decor',140),('Ceiling Lights','ceiling-lights','home-decor','Home Decor',150),('Decorative Lighting','decorative-lighting','home-decor','Home Decor',160)
)
